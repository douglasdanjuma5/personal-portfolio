            ...
            <section className="paralax-mf footer-paralax bg-image sect-mt4 route" style={{backgroundImage: "url("+imageOverlay+")"}}>
                ...
                <div className="row">
                    ...
                    <div className="contact-mf">
                        ...
                        <div className="row">
                            ...
                            <div>
                                <form action="https://formspree.io/douglasdanjuma9@gmail.com" method="POST" className="contactForm">
                            ...
                            <div className="more-info">
                                <p className="lead">
                                    Whether you want to get in touch, talk about a project or project collaboration, or just say hi, I'd love to hear from you.<br />
                            ...
                            <div className="socials">
                                ...
                                <li><a href="https://github.com/douglasdanjuma5" target="_blank" rel="noopener noreferrer"><span className="ico-circle"><i className="ion-social-github"></i></span></a></li>
                ...
                <div className="container">
                    ...
                    <div className="col-sm-12">
                        ...
                        <p className="copyright"> All Rights Reserved &copy; 2019-2020   || <strong>D-SQUARE</strong>. </p>
                        </div>
                    </div>
                    </div>
                </div>
