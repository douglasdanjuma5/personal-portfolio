              ...
              <div className="table-cell">
                <div className="container">
                  ...
                  <p className="intro-subtitle"><span className="text-slider-items">
                    </span><strong className="text-slider"><Typed strings={['Fulstack Developer', 'Software Engineer','Freelancer']} typeSpeed = {80} backDelay = {1100} backSpeed = {30} loop/></strong></p>
